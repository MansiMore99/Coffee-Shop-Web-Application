...
SECRET_KEY = "django-insecure-$$8aw&udu-b(z3-pxdx25sjp+w%t$w=r7(k_p+d=7xsh+@_u7c"
...
DATABASES = {
    'default': {
        ...
        'NAME': 'CafeProject',         
        'USER': 'cafe_user',         # The database user
        'PASSWORD': '123',             # The password for the database user
